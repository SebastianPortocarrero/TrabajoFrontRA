    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <Link to="/" className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold">AREduca</span>
            </Link>
            <p className="mt-4 text-gray-400 max-w-md">
              Transform education with our augmented reality platform. Create immersive learning experiences that bring subjects to life.
            </p>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col md:flex-row items-center justify-between text-gray-400 text-sm">
          <p>© 2025 AREduca. All rights reserved.</p>
